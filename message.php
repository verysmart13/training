...
$data=mysql_query('select * from Messageboard order by guestTime desc');//讓資料由最新呈現到最舊
?>
...
<div class="top">
 <a href="message2.php"><button type="button" class="btn btn-primary btn-lg">我要留言</button></a>
</div>
...
<div class="container">
  <div class="CSSTableGenerator">
      <table align="center">
			...
			<tr>
              <td><a href="message3.php?id=<?php echo $rs['gusetID'] ?>">回覆</a>
            </tr>
            <tr>
              <td width="25%">暱稱</td>
            ...
            <tr>
              <td colspan="2" style="background:#999; color:white; text-align:center">回覆</td>
            </tr>
            <tr>
